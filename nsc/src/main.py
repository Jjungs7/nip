import argparse
import nsc
from nsc.src.train import Instructor
...
def get_args():
    ...
    parser.add_argument('--model_save_path', type=str, default='../absc', help='upper epoch limit')
    ...
    parser.add_argument('--load_model', type=str, default='', help='path of nsc to resume')
