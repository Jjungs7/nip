import numpy as np
from nsc.src.nsc import NSC
from nsc.src.dataset import NIPDataset
...
class Instructor:
    def __init__(self, args):
        ...
        if not args.test:
            self.train_dataset = NIPDataset(args=self.args, data_path=self.args.data_path_prefix + "train-dummy.txt")
            ...
            self.dev_dataset = NIPDataset(args=self.args, data_path=self.args.data_path_prefix + "dev-dummy.txt")
            ...
            self.test_dataset = NIPDataset(args=self.args, data_path=self.args.data_path_prefix + "test-dummy.txt")
